...
var abcMain = function abcMain() {
  var l = window.location;
  var url = (l.protocol === "https:" ? "wss://" : "ws://") + l.hostname + ":" + l.port + "/";
...
var Sender = /*#__PURE__*/function () {
  ...
  _createClass(Sender, [{
    ...
    value: function send(msg) {
      if (this.connected) this.connection.send(msg);
    }
  }]);
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function start() {
      (0, _jquery["default"])(".pad-button").click(function (event) {
    ...
    value: function onClick(element) {
      var name = (0, _jquery["default"])(element).attr("id");
